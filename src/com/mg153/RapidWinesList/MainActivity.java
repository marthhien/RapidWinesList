...
import com.mg153.RapidWinesList.CustomListViewAdapter;
import com.mg153.RapidWinesList.FicheActivity;
import com.mg153.RapidWinesList.LabelActivity;
import com.mg153.RapidWinesList.NoLabelActivity;
import com.mg153.RapidWinesList.NouvFicheActivity;
...
public class MainActivity extends ListActivity {
		...
		getListView().setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			Vin stud = null;
		  		if (getListAdapter().getCount() > 0) {
		  			...
		  			Toast.makeText(MainActivity.this, "Press longer to display the picture", Toast.LENGTH_SHORT).show(); 
		  		}
    ...
    { 
        ...
        case R.id.menu_quit: 
        	...
        	alertDialogQuit.setMessage("Exit the application?");
        	alertDialogQuit.setCancelable(false);
	        	alertDialogQuit.setPositiveButton("Quit", new DialogInterface.OnClickListener() {
               public void onClick(DialogInterface dialog, int id) {
            	   MainActivity.this.finish();
               }
             });
        	alertDialogQuit.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
               public void onClick(DialogInterface dialog, int id) {
                    dialog.cancel();
               }
            });
       ...
       case R.id.menu_imp:
		...
		FileOpenDialog.Default_File_Name = "MyWines.txt";
	...
	case R.id.menu_exp:
		...
		FileOpenDialog2.Default_File_Name = "MyWines.txt";
...
public void upliste(View view) {
    ...
    public void chercherliste() {
        	...
        	alertDialogimport.setMessage("Search for :");
        	...
        	alertDialogimport.setCancelable(false);
	        	alertDialogimport.setPositiveButton("Find", new DialogInterface.OnClickListener() {
               public void onClick(DialogInterface dialog, int id) {
            	  	String txt1 = input1.getText().toString();
            	  	chercher(txt1);
               }
             });
        	alertDialogimport.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
               public void onClick(DialogInterface dialog, int id) {
                    dialog.cancel();
               }
            });
...
/** Send a email **/
   ...
   public void SendEmail() {
    ...
    intent.putExtra(Intent.EXTRA_SUBJECT, "Rapid Wines List Comments");
    intent.putExtra(Intent.EXTRA_TEXT,"Your comment here.  Thank you!" );
    try {
     startActivity(intent);
	...
	/*		aBuffer += aDataRow + "\n";   */			
		...
		selcursor =-1;
		    ...
		    setListAdapter(adapter);
 		   	...
 		   	Toast.makeText(MainActivity.this, "Imported",Toast.LENGTH_LONG).show();  
...
private void exportDB(String path){
	 	...
	 	/*	   Toast.makeText(MainActivity.this, "Unable to save" + e.getMessage() ,Toast.LENGTH_LONG).show();  */ 
