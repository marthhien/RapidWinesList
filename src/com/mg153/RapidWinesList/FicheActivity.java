...
/* lire l'enr */
	...
	public void enregistrer(View view) {
		...
		EditText text1 = (EditText) findViewById(R.id.editnom);
     	...
     	Toast.makeText(FicheActivity.this, "Saved", Toast.LENGTH_SHORT).show(); 
		...
		DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
			...
			if(myFileimg.exists())
			    myFileimg.delete();
            		...
            		Toast.makeText(FicheActivity.this, "Deleted", Toast.LENGTH_SHORT).show(); 
            		finish();
	    ...
	    switch (requestCode) {
	        case TAKE_PICTURE:
	            if (resultCode == Activity.RESULT_OK) {
	                ...
	                imgPath = nomunique;
	        		Toast.makeText(FicheActivity.this, "Photo saving...", Toast.LENGTH_LONG).show(); }
	        		else {
	        			imgPath = nomunique2;
	        }
	    }
